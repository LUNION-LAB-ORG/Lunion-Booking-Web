...
const PriceCard = ({ plan }: { plan: Plan }) => {
    ...
    return (
        <Card className="w-full mx-auto max-w-sm p-4 md:p-8 shadow-md rounded-3xl">
            <div className="mb-4">
                <h2 className="text-2xl font-bold">{formatNumber((plan.price_year * count ))} $</h2>
            ...
            <CardBody className="p-0 space-y-4">
                <div>
                    <form ref={formRef} action={formAction} className="space-y-8">
                        ...
                        <SubmitButton>{trial ? 'Essayer' : 'Souscrire'}</SubmitButton>
                    </form>
                </div>
                ...
                <div className="pt-2">
                    ...
                    <div className="flex items-center space-x-3">
                        <Avatar src="/assets/images/logo_fn.svg" alt="Logo" className="object-contain bg-primary w-12 h-12 border border-primary p-1" />
