...
const ComponentsWidgets = () => {
    ...
    const revenueChart: any = {
        ...
        options: {
            ...
            grid: {
                borderColor: isDark ? '#3f121a' : '#E0E6ED',
                strokeDashArray: 5,
                xaxis: {
                    lines: {
                        show: false,
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                        ...
                                        <td>
                                            <Link href="/template/apps/invoice/preview">#46894</Link>
                                        </td>
                                        <td>$56.07</td>
                                        <td>
                                    ...
                                    <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                        ...
                                        <td>
                                            <Link href="/template/apps/invoice/preview">#76894</Link>
                                        </td>
                                        <td>$126.04</td>
                                        <td>
                                    ...
                                    <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                        ...
                                        <td>
                                            <Link href="/template/apps/invoice/preview">#66894</Link>
                                        </td>
                                        <td>$56.07</td>
                                        <td>
                                            <span className="badge bg-success shadow-md dark:group-hover:bg-transparent">Paid</span>
